...
func (this *MemberController) Index() {
	...
	fmt.Println("tpl")
	fmt.Println(this.Data["activeSidebarUrl"])
	this.setTpl()

	this.TplName = "member/index.html"
	//this.TplName = "member/index.html"
	this.LayoutSections = make(map[string]string)
	this.LayoutSections["headcssjs"] = "member/index_headcssjs.html"
	this.LayoutSections["footerjs"] = "member/index_footerjs.html"
	//页面里按钮权限控制
...
func (c *MemberController) DataGrid() {
...
//DataList 角色列表
func (c *MemberController) DataList() {
	var params = models.RoleQueryParam{}
	//获取数据列表和总数
...
func (c *MemberController) UpdateSeq() {
	Id, _ := c.GetInt("pk", 0)
